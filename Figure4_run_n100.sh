python Main_s4.py --input data/Ns100_SeqN100/Ns100_SeqN100_1.pth.tar --batch-size 1 --net ElmanRNN_tp1 --pred 1 --fixi 1 --n 100 --hidden-n 100 --savename Elman_SGD/Remap_predloss/N100T100/Ns100_SeqN100_predloss_full

python Main_s4.py --input data/Ns100_SeqN100/Ns100_SeqN100_2Batch.pth.tar --batch-size 2 --net ElmanRNN_tp1 --pred 1 --fixi 1 --n 100 --hidden-n 100 --savename Elman_SGD/Remap_predloss/N100T100/Ns100_SeqN100_2Batch_predloss
