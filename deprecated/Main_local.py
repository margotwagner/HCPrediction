...
parser.add_argument(
    "-t", "--total_steps", default=100, type=int, help="Total steps per traversal"
)
parser.add_argument(
    "-p",
    "--print_freq",
...
parser.add_argument(
    ...
    default="bptt",
    type=str,
    help="learning algorithm (default: bptt)",
)
parser.add_argument(
    "--inputfile",
    default="",
    type=str,
    help="name of input file (default: gaussian pc)",
)
...
def main():
    ...
    net, loss_list, grad_list, hidden_rep, output_rep = train_partial(
        y_mini, h0, epochs, lr, learning_alg, print_freq
    )
...
def train_partial(Y_mini, h0, n_epochs, lr, learning_alg, print_freq=1000):
    ...
    return (
        net,
        loss_list,
        [dLdW_list, dLdV_list, dLdU_list, dLdb_list, dLdc_list],
        hidden_rep,
        output_rep,
    )
