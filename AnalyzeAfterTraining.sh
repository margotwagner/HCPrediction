...
python make_figures.py --just 3 --conditions "./runs/ElmanRNN/random-init/random_n100" --figdir ./figs/fig3_baseline

python make_figures.py --just 3 --conditions "./runs/ElmanRNN/shift-variants/identity/frobenius/identity_n100_fro" --figdir ./figs/fig3_identity

# BAD: ./runs/ElmanRNN/mh-variants/cent/frobenius/centmh_n100_fro,./runs/ElmanRNN/mh-variants/cent-cyc/frobenius/centcycmh_n100_fro,
